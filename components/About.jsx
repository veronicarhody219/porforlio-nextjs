      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-4 text-gray-600 ">
            ...
            that I wanted to create something useful with languages, then I
            started my journey to learn programming languages.
          </p>
          ...
          <p className="py-2 text-gray-600 ">
            From the very beginning, I always wanted to learn machine learning
            because I know it would have a very promising future but it was too
            difficult for an absolute beginner like me, that’s why I took the
            JavaScript course, and study more about its frameworks like React
            and Angular. JavaScript is a beautiful language, the more I study
            the more I fall in love with it and now I know I can study machine
            learning with tensorflowjs which is written in JavaScript and that’s
            wonderful. After finishing this course I definitely study machine
            learning with tensorflowjs and then I plan to study Python which is
